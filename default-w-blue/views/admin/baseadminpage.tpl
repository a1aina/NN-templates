...
<head>
	...
	<link href="{$smarty.const.WWW_TOP}/../templates/default-w-blue/styles/admin.css" rel="stylesheet" type="text/css" media="screen" />
	...
	<script type="text/javascript" src="{$smarty.const.WWW_TOP}/templates/default-w-blue/scripts/utils-admin.js"></script>
	<script type="text/javascript" src="{$smarty.const.WWW_TOP}/templates/default-w-blue/scripts/jquery.multifile.js"></script>
