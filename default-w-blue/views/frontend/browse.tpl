...
<table style="width:100%;" class="data highlight icons" id="browsetable">
	<tr>
		...
		<th>name<br/><a title="Sort Descending" href="{$orderbyname_desc}"><img src="{$smarty.const.WWW_TOP}/templates/default-w-blue/images/sorting/arrow_down.gif" alt="Sort Descending" /></a><a title="Sort Ascending" href="{$orderbyname_asc}"><img src="{$smarty.const.WWW_TOP}/templates/default-w-blue/images/sorting/arrow_up.gif" alt="Sort Ascending" /></a></th>
<!-- Added thumbnails column -->
		<th>Thumb</th>		
<!-- End thumbnails column -->		
		<th>category<br/><a title="Sort Descending" href="{$orderbycat_desc}"><img src="{$smarty.const.WWW_TOP}/templates/default-w-blue/images/sorting/arrow_down.gif" alt="Sort Descending" /></a><a title="Sort Ascending" href="{$orderbycat_asc}"><img src="{$smarty.const.WWW_TOP}/templates/default-w-blue/images/sorting/arrow_up.gif" alt="Sort Ascending" /></a></th>
		<th>posted<br/><a title="Sort Descending" href="{$orderbyposted_desc}"><img src="{$smarty.const.WWW_TOP}/templates/default-w-blue/images/sorting/arrow_down.gif" alt="Sort Descending" /></a><a title="Sort Ascending" href="{$orderbyposted_asc}"><img src="{$smarty.const.WWW_TOP}/templates/default-w-blue/images/sorting/arrow_up.gif" alt="Sort Ascending" /></a></th>
		<th>size<br/><a title="Sort Descending" href="{$orderbysize_desc}"><img src="{$smarty.const.WWW_TOP}/templates/default-w-blue/images/sorting/arrow_down.gif" alt="Sort Descending" /></a><a title="Sort Ascending" href="{$orderbysize_asc}"><img src="{$smarty.const.WWW_TOP}/templates/default-w-blue/images/sorting/arrow_up.gif" alt="Sort Ascending" /></a></th>
		<th>files<br/><a title="Sort Descending" href="{$orderbyfiles_desc}"><img src="{$smarty.const.WWW_TOP}/templates/default-w-blue/images/sorting/arrow_down.gif" alt="Sort Descending" /></a><a title="Sort Ascending" href="{$orderbyfiles_asc}"><img src="{$smarty.const.WWW_TOP}/templates/default-w-blue/images/sorting/arrow_up.gif" alt="Sort Ascending" /></a></th>
		<th>stats<br/><a title="Sort Descending" href="{$orderbystats_desc}"><img src="{$smarty.const.WWW_TOP}/templates/default-w-blue/images/sorting/arrow_down.gif" alt="Sort Descending" /></a><a title="Sort Ascending" href="{$orderbystats_asc}"><img src="{$smarty.const.WWW_TOP}/templates/default-w-blue/images/sorting/arrow_up.gif" alt="Sort Ascending" /></a></th>
		<th></th>
	</tr>
		...
		<tr class="{cycle values=",alt"}{if $lastvisit|strtotime<$result.adddate|strtotime} new{/if}" id="guid{$result.guid}">
			...
			<label for="chk{$result.guid|substr:0:7}"><a class="title" title="View details" href="{$smarty.const.WWW_TOP}/details/{$result.guid}/{$result.searchname|escape:"seourl"}">{$result.searchname|escape:"htmlall"|replace:".":" "}</a></label>		
				{if $result.passwordstatus == 2}
					<img title="Passworded Rar Archive" src="{$smarty.const.WWW_TOP}/templates/default-w-blue/images/icons/lock.gif" alt="Passworded Rar Archive" />
				{elseif $result.passwordstatus == 1}
					<img title="Contains .cab/ace/rar Archive" src="{$smarty.const.WWW_TOP}/templates/default-w-blue/images/icons/lock.gif" alt="Contains .cab/ace/rar Archive" />
				{/if}

				{if $userdata.canpre == 1 && $result.nuketype != ''}
					&nbsp;<img title="{$result.nuketype}" src="{$smarty.const.WWW_TOP}/templates/default-w-blue/images/icons/nuke.png" width="10" height="10" alt="{$result.nuketype}" />
				{/if}
			...
			<td class="less mid">
				...
				{if $result.rarinnerfilecount > 0}
					<div class="rarfilelist">
						<img src="{$smarty.const.WWW_TOP}/templates/default-w-blue/images/icons/magnifier.png" alt="{$result.guid}" class="tooltip" />				
					</div>
				{/if}
			</td>
