...
<div class="pager">
	{if $currentpage > 1}
		<a title="Goto Previous page" href="{$pagerquerybase}{$pageroffset-$pageritemsperpage}{$pagerquerysuffix}">&laquo; Previous</a>&nbsp;
	...
	{if ($currentpage) < $pages}
                &nbsp;<a title="Goto Next page" href="{$pagerquerybase}{$pageroffset+$pageritemsperpage}{$pagerquerysuffix}">Next &raquo;</a>
        {/if}
